...
import { capperSignup, clearSessionErrors } from '../../actions/session_actions';
import './signup.css';
...
const mapDispatchToProps = dispatch => ({
  signup: (user) => dispatch(capperSignup(user)),
  clearSignupErrors: () => dispatch(clearSessionErrors())
})

class CapperSignup extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      username: '',
...
export default connect(mapStateToProps, mapDispatchToProps)(CapperSignup);